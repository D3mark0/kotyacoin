...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 paws per kB (0.00001 KOT). This is to prepare for dropping the minimum transaction fee to 0.1 paws per kB (0.0001 KOT) in the next release.
