...
#if defined(NDEBUG)
# error "Kotyacoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Kotyacoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KOT additional fees, %d delta bytes\n",
