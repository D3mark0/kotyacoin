...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kotyacoin-project/kotyacoin>";
    const std::string URL_WEBSITE = "<https://kotyacoin.org>";
