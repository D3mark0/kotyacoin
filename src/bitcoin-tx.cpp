...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kotyacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kotyacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kotyacoin transaction") + "\n" +
              "  kotyacoin-tx [options] -create [commands]   " + _("Create hex-encoded kotyacoin transaction") + "\n" +
              "\n";
